...
f = tab['U_auto'] <= 21.6
f1 = tab['F0378_auto'] <= 21.5
f2 = tab['F0395_auto'] < 21.4
f3 = tab['F0410_auto'] <= 21.5
f4 = tab['F0430_auto'] < 21.4
f5 = tab['G_auto'] <= 22.2
f6 = tab['J0515_auto'] <= 21.4
f7 = tab['R_auto'] <= 21.9
f8 = tab['F0660_auto'] <= 21.3
f9 = tab['I_auto'] <= 20.8
f10 = tab['F0861_auto'] <= 20.8
f11 = tab['Z_auto'] <= 20.5
...
#Mask
#Mask filters
q = (tab['F0515_auto'] - tab['F0660_auto']) <= 5.0
#q1 = (tab['J0515'] - tab['J0861']) >= -3.0
q2 = (tab['R_auto'] - tab['F0660_auto']) <= 4.0
q3 = (tab['R_auto'] - tab['I_auto']) >= -4.0
q4 = (tab['G_auto'] - tab['F0515_auto']) >= -3.2
q5 = (tab['G_auto'] - tab['I_auto']) >= -3.0
q6 = (tab['F0410_auto'] - tab['F0660_auto']) <= 6.0
q7 = (tab['Z_auto'] - tab['G_auto']) <= 4.0

mask1 = q  & q2 & q3 & q4 & q5 & q6 & q7
#Mask
Y = 2.7*(tab['F0515_auto'] - tab['F0861_auto']) + 2.15
Y1 = 0.2319*(tab['Z_auto'] - tab['G_auto']) + 0.85
Y2 = -1.3*(tab['Z_auto'] - tab['G_auto']) + 1.7
Y3 = 1.559*(tab['F0660_auto'] - tab['R_auto']) + 0.58
Y4 = 0.12*(tab['F0660_auto'] - tab['R_auto']) - 0.01
Y44 = -1.1*(tab['F0660_auto'] - tab['R_auto']) - 1.07
Y5 = 8.0*(tab['G_auto'] - tab['I_auto']) + 4.5
Y6 = 0.8*(tab['G_auto'] - tab['I_auto']) + 0.55
Y7 = 0.43*(tab['R_auto'] - tab['I_auto']) + 0.65
Y8 = -6.8*(tab['R_auto'] - tab['I_auto']) - 1.3

m = tab['Class star'] > 0.0 
m1 = tab['F0660_auto'] - tab['R_auto']<=-1.0 
m2 = tab['F0515_auto'] - tab['F0660_auto']>=0.3
m3 = tab['Z_auto'] - tab['F0660_auto']>=Y1
m4 = tab['Z_auto'] - tab['F0660_auto']>=Y2
m5 = tab['F0515_auto'] - tab['F0660_auto']>=Y
m6 = tab['F0660_auto'] - tab['G_auto']>=Y3
m7 = tab['G_auto'] - tab['F0515_auto']<=Y4
m8 = tab['G_auto'] - tab['F0515_auto']<=Y44
m9 = tab['F0410_auto'] - tab['F0660_auto']>=Y5
m10 = tab['F0410_auto'] - tab['F0660_auto']>=Y6
m11 = (tab['R_auto'] - tab['F0660_auto']) >= Y7
m12 = (tab['R_auto'] - tab['F0660_auto']) <= Y8
...
asciifile = "PN-SPLUS_STRIPE82_DataRelease-Junio18_auto.tab"
try:
