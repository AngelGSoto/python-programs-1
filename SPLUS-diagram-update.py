...
ax2.set_xlim(xmin=-2.0,xmax=6.0)
ax2.set_ylim(ymin=-2.0,ymax=5.3)
...
ax2.scatter(B1[142], A1[142],  c= "green", alpha=0.3, s=42,  marker='*',  label='CLOUDY modelled HPNe')
ax2.scatter(B1[0], A1[0], c='black', alpha=0.8, s=40, label='Obs. HPNe')
...
ax2.errorbar(B1[139], A1[139], yerr=0.2,  lolims= True,  marker='.', fmt='k.', elinewidth=.8, markeredgewidth=.8, markersize=8,)
...
ax2.scatter(B1[129], A1[129],  c= "gray", alpha=0.8, s=40, marker='D', label='Obs. H II region in NGC 55')
...
ax2.scatter(B1[126], A1[126],  c= "white", alpha=0.3, s=40, marker='^', label='SDSS SFGs ')
...
ax2.scatter(B1[133], A1[133],  c= "red", alpha=0.8, s=40, marker='D', label='Obs. SySts in NGC 205')
ax2.scatter(B1[134], A1[134],  c='red', alpha=0.8, s=40, marker='D')  #label=' SySts in NGC 205')
...
ax2.scatter(B1[138], A1[138],  c='red', alpha=0.8, s=40, marker='o',  label='Obs. SySts in IC10 ')
ax2.scatter(B1[137], A1[137],  c= "red", alpha=0.8, s=40, marker='v', label='Obs. SySts in NGC 185')
...
plt.tight_layout()
#plt.savefig('luis-JPLUS-Viironen.pdf')#,  bbox_extra_artists=(lgd,), bbox_inches='tight')
plt.savefig('Fig2-SPLUS-j0515-J0660-v2.pdf')
plt.clf()
sys.exit()
############################################################################
#Ha - gSDSS vs Ha-r
...
for file_name1 in file_list1:
    with open(file_name1) as f1:
        data1 = json.load(f1)
        fil1 = data1["J0660"]-25+20.859#-1.12
        fil2 = data1["J0480_gSDSS"]-25+23.297
        fil3 = data1["J0625_rSDSS"]-25+23.335
        diff = fil1 - fil2
        diff0 = fil1 - fil3
        d_644_jplus.append(diff)
        d_768_jplus.append(diff0)
...
for file_name2 in file_list2:
    with open(file_name2) as f2:
        data2 = json.load(f2)
        fil1 = data2["J0660"]-25+21.058#-1.162
        fil2 = data2["J0480_gSDSS"]-25+23.425
        fil3 = data2["J0625_rSDSS"]-25+23.565
        diff = fil1 - fil2
        diff0 = fil1 - fil3
        d_644_jplus.append(diff)
        d_768_jplus.append(diff0)
...
#Progation error with Valera's erros
err_Val_h4x= np.sqrt(err_zpVale_h4[6]**2+err_zpVale_h4[5]**2)
err_Val_h4y= np.sqrt(err_zpVale_h4[6]**2+err_zpVale_h4[3]**2)
err_Val_pn135x= np.sqrt(err_zpVale_pn135[6]**2+err_zpVale_pn135[5]**2)
err_Val_pn135y= np.sqrt(err_zpVale_pn135[6]**2+err_zpVale_pn135[3]**2)
...
ax3.set_xlim(xmin=-2.5,xmax=1.0)
ax3.set_ylim(ymin=-5.0,ymax=1.0)
#ax3.set_xlim(xmin=-2.5,xmax=2.0)
plt.tick_params(axis='x', labelsize=20) 
plt.tick_params(axis='y', labelsize=20)
plt.xlabel(r'$J0660 - rSDSS$', fontsize= 22)
plt.ylabel(r'$J0660 - gSDSS$', fontsize= 22)
...
ax3.errorbar(B1[139], A1[139], yerr=0.25,  uplims= True,  marker='.', fmt='k.', elinewidth=.8, markeredgewidth=.8, markersize=8,)
ax3.errorbar(B1[139], A1[139], xerr=0.15,  xuplims= True,  marker='.', fmt='k.', elinewidth=.8, markeredgewidth=.8, markersize=8,)
...
ax3.scatter(B1[129], A1[129],  c= "gray", alpha=0.8, s=40, marker='D', label='Obs. H II region in NGC 55')
ax3.scatter(B1[1], A1[1], c='purple', alpha=0.8, s=40, label='SDSS CVs')
ax3.scatter(B1[123], A1[123],  c= "mediumaquamarine" , alpha=0.8, s=40, marker='s',  label='SDSS QSOs (1.3<z<1.4)')
ax3.scatter(B1[124], A1[124],  c= "royalblue", alpha=0.8, marker='D', s=40, label='SDSS QSOs (2.4<z<2.6)')
ax3.scatter(B1[125], A1[125],  c= "goldenrod", alpha=0.8, s=40, marker='^', label='SDSS QSOs (3.2<z<3.4)')
ax3.scatter(B1[126], A1[126],  c= "white", alpha=0.3, s=40, marker='^', label='SDSS SFGs ')
ax3.scatter(B1[127], A1[127],  c='red', alpha=0.8, s=40, marker='s')#, label='Obs. SySts ')
ax3.scatter(B1[135], A1[135],  c= "red", alpha=0.8, s=40, marker='s', label='Obs. SySts ')
#ax3.scatter(B1[72], A1[72],  c= "red", alpha=0.8, marker='D', label='Symbiotics in NGC 55')
ax3.scatter(B1[133], A1[133],  c= "red", alpha=0.8, s=40, marker='D', label='Obs. SySts in NGC 205')
ax3.scatter(B1[134], A1[134],  c='red', alpha=0.8, s=40, marker='D')  #label=' SySts in NGC 205')
ax3.scatter(B1[128], A1[128],  c='red', alpha=0.8, s=40, marker='^')#,  label='IPHAS SySts')
ax3.scatter(B1[136], A1[136],  c= "red", alpha=0.8, s=40, marker='^', label='IPHAS SySts')
ax3.scatter(B1[138], A1[138],  c='red', alpha=0.8, s=40, marker='o',  label='Obs. SySts in IC10 ')
ax3.scatter(B1[137], A1[137],  c= "red", alpha=0.8, s=40, marker='v', label='Obs. SySts in NGC 185')
...
ax3.annotate("H4-1", (np.array(B1[139]), np.array(A1[139])), alpha=10, size=8,
                   xytext=(12, 5), textcoords='offset points', ha='right', va='bottom',)
...
ax3.annotate("DdDm-1", (np.array(B1[141]), np.array(A1[141])), alpha=10, size=8,
                   xytext=(32, -12), textcoords='offset points', ha='right', va='bottom',)
...
ax3.legend(scatterpoints=1, ncol=1, fontsize=11.0, loc='lower right', **lgd_kws)
ax3.grid()
#lgd = ax3.legend(loc='center right', bbox_to_anchor=(1.27, 0.5), fontsize=7.5, **lgd_kws)
#ax3y.grid(which='minor', lw=0.5)
#sns.despine(bottom=True)
plt.tight_layout()
#plt.savefig('luis-JPLUS-Viironen.pdf')#,  bbox_extra_artists=(lgd,), bbox_inches='tight')
plt.savefig('Fig3-SPLUS-halpha-r-v2.pdf')
plt.clf()
