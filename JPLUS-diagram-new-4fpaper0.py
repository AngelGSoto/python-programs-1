...
def plot_mag(f1, f2, f3, f4):
    ...
    x123, y123= filter_mag("QSOs-hz", "", f1, f2, f3, f4)
    x124, y124 = filter_mag("QSOs-010", "",  f1, f2, f3, f4)
    x125, y125 = filter_mag("QSOs-101", "", f1, f2, f3, f4)
    x126, y126 = filter_mag("QSOs-201", "", f1, f2, f3, f4)
    x127, y127 = filter_mag("QSOs-301", "", f1, f2, f3, f4)
    x128, y128 = filter_mag("QSOs-401", "", f1, f2, f3, f4)
    x129, y129 = filter_mag("-SFGs", "", f1, f2, f3, f4)
    x130, y130 = filter_mag("-sys", "", f1, f2, f3, f4)
    x131, y131 = filter_mag("-sys-IPHAS", "", f1, f2, f3, f4) 
    x132, y132 = filter_mag("-ExtHII", "", f1, f2, f3, f4)
    x133, y133 = filter_mag("-sys-Ext", '', f1, f2, f3, f4)
    x134, y134 = filter_mag("-survey", '', f1, f2, f3, f4)
    x135, y135 = filter_mag("-SNR", '', f1, f2, f3, f4)
    x136, y136 = filter_mag("extr-SySt-raman", '', f1, f2, f3, f4)
    x137, y137 = filter_mag("-extr-SySt", '', f1, f2, f3, f4)
    x138, y138 = filter_mag("-sys-raman", "", f1, f2, f3, f4)
    x139, y139 = filter_mag("-sys-IPHAS-raman", "", f1, f2, f3, f4)
    x140, y140 = filter_mag("ngc185-raman", "", f1, f2, f3, f4)
    x141, y141 = filter_mag("SySt-ic10", "", f1, f2, f3, f4)
    x142, y142 = filter_mag("LOAN-HPNe-", "", f1, f2, f3, f4)
    x143, y143 = filter_mag("1359559-HPNe-", "", f1, f2, f3, f4)
    x144, y144 = filter_mag("E00", "", f1, f2, f3, f4)
    x145, y145 = filter_mag("E01", "", f1, f2, f3, f4)
    x146, y146 = filter_mag("E02", "", f1, f2, f3, f4)
    x147, y147 = filter_mag("E00_900", "", f1, f2, f3, f4)
    x148, y148 = filter_mag("E01_900", "", f1, f2, f3, f4)
    x149, y149 = filter_mag("E02_900", "", f1, f2, f3, f4)
    for a, b in zip(x, y):
        A1[0].append(a)
        B1[0].append(b)
...
for file_name in file_list:
    with open(file_name) as f:
        ...
        if data['id'].startswith("ngc"):
            ...
            label.append("")
        plot_mag("F480_g_sdss", "F515", "F660", "F610_r_sdss")
...
err_zp_h4 = [0.128, 0.020, 0.303, 0.227, 0.235, 0.165, 0.160, 0.138, 0.145, 0.177, 0.193, 0.092]
err_zp_pn135 =[0.102, 0.0, 0.314, 0.341, 0.273, 0.261, 0.257, 0.269, 0.309, 0.273, 0.215, 0.100 ]
...
for file_name1 in file_list1:
    with open(file_name1) as f1:
        data1 = json.load(f1)
        fil1 = data1["J0480_gSDSS"]-25+23.297#-1.12
        fil2 = data1["J0515"]-25+21.193
        fil3 = data1["J0660"]-25+20.859
        fil4 = data1["J0625_rSDSS"]-25+23.335
        diff = fil1 - fil2
        diff0 = fil3 - fil4
...
#err_h41x, err_h41y = [], []
#for i in err_zp_h4:
err_h4x = np.sqrt(err_zp_h4[8]**2+err_zp_h4[7]**2)
err_h4y = np.sqrt(err_zp_h4[5]**2+err_zp_h4[6]**2)
...
for file_name2 in file_list2:
    with open(file_name2) as f2:
        data2 = json.load(f2)
        fil1 = data2["J0480_gSDSS"]-25+23.425#-1.12
        fil2 = data2["J0515"]-25+21.444
        fil3 = data2["J0660"]-25+21.058
        fil4 = data2["J0625_rSDSS"]-25+23.565
        diff = fil1 - fil2
        diff0 = fil3 - fil4
        d_644_jplus.append(diff)
        d_768_jplus.append(diff0)
...
err_pn13x = np.sqrt(err_zp_pn135[8]**2+err_zp_pn135[7]**2)
err_pn13y = np.sqrt(err_zp_pn135[5]**2+err_zp_pn135[6]**2)
    # err_pn135x.append(err_pn13)
    # err_pn135y.append(err_pn13_)

# Error observed paper
err_sdss_pn35x=np.sqrt(err_obser_pn135[2]**2+err_obser_pn135[3]**2)
err_sdss_pn35y=np.sqrt(err_obser_pn135[0]**2+err_obser_pn135[1]**2)

#Progation error with Valera's erros
err_Val_h4x= np.sqrt(err_zpVale_h4[6]**2+err_zpVale_h4[7]**2)
err_Val_h4y= np.sqrt(err_zpVale_h4[3]**2+err_zpVale_h4[4]**2)
err_Val_pn135x= np.sqrt(err_zpVale_pn135[6]**2+err_zpVale_pn135[7]**2)
err_Val_pn135y= np.sqrt(err_zpVale_pn135[3]**2+err_zpVale_pn135[4]**2)
...
ax1.set_xlim(xmin=-3.0,xmax=2.5)
ax1.set_ylim(ymin=-3.5,ymax=1.5)
#ax1.set_xlim(xmin=-2.5,xmax=2.0)
plt.tick_params(axis='x', labelsize=18) 
plt.tick_params(axis='y', labelsize=18)
plt.xlabel(r'$J0660 - r$', fontsize= 22)
plt.ylabel(r'$g - J0515$', fontsize= 22)
...
ax1.scatter(B1[143], A1[143],  c= "magenta", alpha=0.6, s=40,  marker='s',  label='CLOUDY modelled HPNe')
...
ax1.scatter(-100, -100,  c= "g", alpha=0.8, marker='o', s=70, label='J-PLUS PNG 135.9+55.9')
ax1.scatter(B1[0], A1[0], c='black', alpha=0.8, s=40, label='Obs. HPNe')
...
ax1.errorbar(B1[141], A1[141], yerr=0.2,  uplims= True,  marker='.', fmt='k.', elinewidth=.8, markeredgewidth=.8, markersize=8,)
...
for cap in caps:
    cap.set_markeredgewidth(1)
ax1.scatter(d_768_jplus[1], d_644_jplus[1],  c= "g", alpha=0.8, marker='o', s=70)
...
for cap in caps:
    cap.set_markeredgewidth(1)
ax1.scatter(B1[131], A1[131],  c= "gray", alpha=0.8, s=40, marker='D', label='Obs. H II regions in NGC 55')
...
ax1.scatter(B1[129], A1[129],  c= 'red', alpha=0.8, s=40, marker='s')#, label='Obs. SySts ')
...
ax1.scatter(100, -100,  c= "red", alpha=0.8, s=40, marker='D', label='Obs. SySts in NGC 205')
ax1.scatter(100, -100,  c= "red", alpha=0.8, s=40, marker='D')  #label=' SySts in NGC 205')
ax1.scatter(100, -100,  c= "red", alpha=0.8, s=40, marker='^')#,  label='IPHAS SySts')
ax1.scatter(100, -100,  c= "red", alpha=0.8, s=40, marker='o',  label='Obs. SySts in IC10 ')
ax1.scatter(100, -100,  c= "red", alpha=0.8, s=41, marker='v', label='Obs. SySts in NGC 185')
ax1.scatter(B1[1], A1[1], c='purple', alpha=0.8, s=40, label='SDSS CVs')
ax1.scatter(B1[124], A1[124],  c= "mediumaquamarine", alpha=0.6, s=40,  marker='D')
ax1.scatter(B1[123], A1[123],  c= "mediumaquamarine", alpha=0.6, marker='D', s=40)
ax1.scatter(B1[126], A1[126],  c= "mediumaquamarine", alpha=0.6, s=40, marker='D')
ax1.scatter(B1[125], A1[125],  c= "mediumaquamarine", alpha=0.6, s=40, marker='D')
ax1.scatter(100, -100,  c= "white", alpha=0.3, s=41, marker='^', label='SDSS SFGs')
ax1.scatter(B1[127], A1[127],  c= "mediumaquamarine" , alpha=0.6, marker='D', s=40, label='SDSS QSOs')
ax1.scatter(B1[138], A1[138],  c= "red", alpha=0.8, s=41, marker='^')
#ax1.scatter(B1[72], A1[72],  c= "red", alpha=0.8, marker='D', label='Symbiotics in NGC 55')
ax1.scatter(B1[135], A1[135],  c= "red", alpha=0.8, s=40, marker='D')
ax1.scatter(B1[136], A1[136],  c= "red", alpha=0.8, s=40, marker='D')  #label=' SySts in NGC 205')
ax1.scatter(B1[130], A1[130],  c= "red", alpha=0.8, s=40, marker='^')#,  label='IPHAS SySts')
ax1.scatter(B1[140], A1[140],  c= "red", alpha=0.8, s=40, marker='o')
ax1.scatter(B1[139], A1[139],  c= "red", alpha=0.8, s=41, marker='v')
ax1.scatter(B1[128], A1[128],  c= "white", alpha=0.3, s=41, marker='^')
...
for label_, x, y in zip(label, B1[0], A1[0]):
    ax1.annotate(label_, (x, y), alpha=5, size=8,
                   xytext=(23.0, 3), textcoords='offset points', ha='right', va='bottom',)

ax1.annotate("H4-1", (np.array(B1[141]), np.array(A1[141])), alpha=5, size=8,
                   xytext=(21, 2), textcoords='offset points', ha='right', va='bottom',)
...
plt.savefig('Fig2-JPLUS-g-r-J660-v6.pdf')
plt.clf()
