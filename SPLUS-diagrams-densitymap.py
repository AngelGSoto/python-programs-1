...
plt.ylabel(r'$r - J0660$', fontsize=20)
...
plt.savefig('Fig1-SPLUS-Viironen-densitymap.pdf')
plt.clf()
...
#plt.savefig('luis-JPLUS-Viironen.pdf')#,  bbox_extra_artists=(lgd,), bbox_inches='tight')
plt.tight_layout()
plt.savefig('Fig2-SPLUS-j0515-halpha-densitymap.jpg')
plt.clf()
...
#plt.savefig('luis-JPLUS-Viironen.pdf')#,  bbox_extra_artists=(lgd,), bbox_inches='tight')
plt.tight_layout()
plt.savefig('Fig3-SPLUS-z-g-densitymap.pdf')
plt.clf()
...
plt.savefig('Fig4-SPLUS-f660-r-densitymap.pdf')
plt.clf()
