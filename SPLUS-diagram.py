...
ax1.set_ylim(ymin=-1.0,ymax=2.6)
...
ax1.legend(scatterpoints=1, ncol=1, fontsize=8.0, loc='lower left', **lgd_kws)
ax1.grid()
...
ax2.set_ylim(ymin=-1.0,ymax=5.5)
plt.tick_params(axis='x', labelsize=15) 
plt.tick_params(axis='y', labelsize=15)
...
ax6.set_xlim(xmin=-5.5,xmax=2.5)
ax6.set_ylim(ymin=-3.5,ymax=4.8)
#ax6.set_xlim(xmin=-2.5,xmax=2.0)
plt.tick_params(axis='x', labelsize=15) 
plt.tick_params(axis='y', labelsize=15)
plt.xlabel(r'zSDSS - gSDSS', fontsize= 16)
plt.ylabel(r'zSDSS - J0660', fontsize= 16)
ax6.scatter(B1[62], A1[62],  c= "orange", alpha=.8, marker='s', s=7, lw=0, cmap=plt.cm.spectral )
ax6.scatter(B1[63], A1[63],  c= "orange", alpha=.8, marker='D', s=7,  lw=0, cmap=plt.cm.spectral)
ax6.scatter(B1[64], A1[64],  c= "orange", alpha=.8, marker='^', s=17, lw=0, cmap=plt.cm.spectral)
ax6.scatter(B1[65], A1[65],  c= "orange", alpha=.8, marker='*', s=17, lw=0, cmap=plt.cm.spectral)
ax6.scatter(B1[66], A1[66],  c= "green", alpha=.8, marker='s', s=7, lw=0, cmap=plt.cm.spectral)
ax6.scatter(B1[67], A1[67],  c= "green", alpha=.8, marker='D', s=7, lw=0, cmap=plt.cm.spectral)
ax6.scatter(B1[68], A1[68],  c= "green", alpha=.8, marker='^', s=17, lw=0, cmap=plt.cm.spectral)
ax6.scatter(B1[69], A1[69],  c= "green", alpha=.8, marker='*', s=17, lw=0, cmap=plt.cm.spectral)
ax6.scatter(B1[70], A1[70],  c= "brown", alpha=.8, marker='s', s=7, lw=0, cmap=plt.cm.spectral)
ax6.scatter(B1[71], A1[71],  c= "brown",  alpha=.8, marker='D', s=7, lw=0, cmap=plt.cm.spectral)
ax6.scatter(B1[72], A1[72],  c= "brown",  alpha=.8, marker='^', s=17, lw=0, cmap=plt.cm.spectral)
ax6.scatter(B1[73], A1[73],  c= "brown",  alpha=.8, marker='*', s=17, lw=0, cmap=plt.cm.spectral)
ax6.scatter(B1[74], A1[74],  c= "cyan",  alpha=.8, marker='s', s=7, lw=0, cmap=plt.cm.spectral)
ax6.scatter(B1[75], A1[75],  c= "cyan",  alpha=.8, marker='D', s=7, lw=0, cmap=plt.cm.spectral)
ax6.scatter(B1[76], A1[76],  c= "cyan", alpha=.8, marker='^', s=17, lw=0, cmap=plt.cm.spectral)
ax6.scatter(B1[77], A1[77],  c= "cyan",  alpha=.8, marker='*', s=17, lw=0, cmap=plt.cm.spectral)
ax6.scatter(B1[78], A1[78],  c= "magenta",   alpha=.8, marker='s', s=7, lw=0, cmap=plt.cm.spectral)
ax6.scatter(B1[79], A1[79],  c= "magenta",  alpha=.8, marker='D', s=7, lw=0, cmap=plt.cm.spectral)
ax6.scatter(B1[80], A1[80],  c= "magenta",   alpha=.8, marker='^', s=17, lw=0, cmap=plt.cm.spectral)
ax6.scatter(B1[81], A1[81],  c= "magenta",  alpha=.8, marker='*', s=17, lw=0, cmap=plt.cm.spectral)
ax6.scatter(B1[82], A1[82],  c= "orange",   alpha=.8, s=13,  marker='s', lw=0, cmap=plt.cm.spectral)
ax6.scatter(B1[83], A1[83],  c= "orange",   alpha=.8, s=13,  marker='D', lw=0, cmap=plt.cm.spectral)
ax6.scatter(B1[84], A1[84],  c= "orange",   alpha=.8, s=23,  marker='^', lw=0, cmap=plt.cm.spectral)
ax6.scatter(B1[85], A1[85],  c= "orange",   alpha=.8, s=23,  marker='*', lw=0, cmap=plt.cm.spectral)
ax6.scatter(B1[86], A1[86],  c= "green",  alpha=.8, s=13,  marker='s', lw=0, cmap=plt.cm.spectral)
ax6.scatter(B1[87], A1[87],  c= "green", alpha=.8, s=13,  marker='D', lw=0, cmap=plt.cm.spectral)
ax6.scatter(B1[88], A1[88],  c= "green", alpha=.8, s=23,  marker='^', lw=0, cmap=plt.cm.spectral)
ax6.scatter(B1[89], A1[89],  c= "green", alpha=.8, s=23,  marker='*', lw=0, cmap=plt.cm.spectral)
ax6.scatter(B1[90], A1[90],  c= "brown", alpha=.8, s=13,  marker='s', lw=0, cmap=plt.cm.spectral)
ax6.scatter(B1[91], A1[91],  c= "brown", alpha=.8, s=13,  marker='D', lw=0, cmap=plt.cm.spectral)
ax6.scatter(B1[92], A1[92],  c= "brown", alpha=.8, s=23,  marker='^', lw=0, cmap=plt.cm.spectral)
ax6.scatter(B1[93], A1[93],  c= "brown", alpha=.8, s=23,  marker='*', lw=0, cmap=plt.cm.spectral)
ax6.scatter(B1[94], A1[94],  c= "cyan", alpha=.8, s=13,  marker='s', lw=0, cmap=plt.cm.spectral)
ax6.scatter(B1[95], A1[95],  c= "cyan", alpha=.8, s=13,  marker='D', lw=0, cmap=plt.cm.spectral)
ax6.scatter(B1[96], A1[96],  c= "cyan", alpha=.8, s=23,  marker='^', lw=0, cmap=plt.cm.spectral)
ax6.scatter(B1[97], A1[97],  c= "cyan", alpha=.8, s=23,  marker='*', lw=0, cmap=plt.cm.spectral)
ax6.scatter(B1[98], A1[98],  c= "magenta", alpha=.4, s=13,  marker='s', lw=0, cmap=plt.cm.spectral)
ax6.scatter(B1[99], A1[99],  c= "magenta", alpha=.8, s=13,  marker='D', lw=0, cmap=plt.cm.spectral)
ax6.scatter(B1[100], A1[100],  c= "magenta", alpha=.8, s=23,  marker='^', lw=0, cmap=plt.cm.spectral)
ax6.scatter(B1[101], A1[101],  c= "magenta", alpha=.8, s=23,  marker='*', lw=0, cmap=plt.cm.spectral)
ax6.scatter(B1[102], A1[102],  c= "orange", alpha=.8, s=30,   marker='s', lw=0, cmap=plt.cm.spectral)#, label='BM DdDm1 L2') #
ax6.scatter(B1[103], A1[103],  c= "orange", alpha=.8, s=30,  marker='D', lw=0, cmap=plt.cm.spectral)#, label='BM DdDm1 L3')
ax6.scatter(B1[104], A1[104],  c= "orange", alpha=.8, s=40,  marker='^', lw=0, cmap=plt.cm.spectral)#, label='BM DdDm1 L4')
ax6.scatter(B1[105], A1[105],  c= "orange", alpha=.8, s=40,  marker='*', lw=0, cmap=plt.cm.spectral)#, label='BM DdDm1 L5')
ax6.scatter(B1[106], A1[106],  c= "green", alpha=.8, s=30,  marker='s', lw=0, cmap=plt.cm.spectral)#,  label='BM N2242 L2')
ax6.scatter(B1[107], A1[107],  c= "green", alpha=.8, s=30,  marker='D', lw=0, cmap=plt.cm.spectral)#,  label='BM N2242 L3')
ax6.scatter(B1[108], A1[108],  c= "green", alpha=.8, s=40,  marker='^', lw=0, cmap=plt.cm.spectral)#,  label='BM N2242 L4')
ax6.scatter(B1[109], A1[109],  c= "green", alpha=.8, s=40,  marker='*', lw=0, cmap=plt.cm.spectral)#,  label='BM N2242 L5')
ax6.scatter(B1[110], A1[110],  c= "brown", alpha=.8, s=30,  marker='s', lw=0, cmap=plt.cm.spectral)#, label='BM K648 L2')
ax6.scatter(B1[111], A1[111],  c= "brown", alpha=.8, s=30,  marker='D', lw=0, cmap=plt.cm.spectral)#, label='BM K648 L3')
ax6.scatter(B1[112], A1[112],  c= "brown", alpha=.8, s=40,  marker='^', lw=0, cmap=plt.cm.spectral)#, label='BM K648 L4')
ax6.scatter(B1[113], A1[113],  c= "brown", alpha=.8, s=40,  marker='*', lw=0, cmap=plt.cm.spectral)#, label='BM K648 L5')
ax6.scatter(B1[114], A1[114],  c= "cyan", alpha=.8, s=30,  marker='s', lw=0, cmap=plt.cm.spectral)#, label='BM BB1 L2')
ax6.scatter(B1[115], A1[115],  c= "cyan", alpha=.8, s=30,  marker='D', lw=0, cmap=plt.cm.spectral)#, label='BM BB1 L3')
ax6.scatter(B1[116], A1[116],  c= "cyan", alpha=.8, s=40,  marker='^', lw=0, cmap=plt.cm.spectral)#, label='BM BB1 L4')
ax6.scatter(B1[117], A1[117],  c= "cyan", alpha=.8, s=40,  marker='*', lw=0, cmap=plt.cm.spectral)#, label='BM BB1 L5')
ax6.scatter(B1[118], A1[118],  c= "magenta", alpha=.8, s=30,  marker='s', lw=0, cmap=plt.cm.spectral)#, label='BM Typ L2')
ax6.scatter(B1[119], A1[119],  c= "magenta", alpha=.8, s=30,  marker='D', lw=0, cmap=plt.cm.spectral)#, label='BM Typ L3')
ax6.scatter(B1[120], A1[120],  c= "magenta", alpha=.8, s=40,  marker='^', lw=0, cmap=plt.cm.spectral)#, label='BM Typ L4')
ax6.scatter(B1[121], A1[121],  c= "magenta", alpha=.8, s=40,  marker='*', lw=0, cmap=plt.cm.spectral)#, label='BM Typ L5')
ax6.scatter(B1[2], A1[2], facecolors='none', edgecolors='orange', alpha=0.8, marker='s', s=7)      # c= "orange", alpha=0.8, marker='s', s=7 )
ax6.scatter(B1[3], A1[3], facecolors='none', edgecolors='orange', alpha=0.8, marker='D', s=7)
ax6.scatter(B1[4], A1[4],  facecolors='none', edgecolors='orange', alpha=0.8, marker='^', s=17)
ax6.scatter(B1[5], A1[5], facecolors='none', edgecolors='orange', alpha=0.8, marker='*', s=17)
ax6.scatter(B1[6], A1[6], facecolors='none', edgecolors='green', alpha=0.8, marker='s', s=7)      # c= "green", alpha=0.8, marker='s', s=7)
ax6.scatter(B1[7], A1[7], facecolors='none', edgecolors='green', alpha=0.8, marker='D', s=7)
ax6.scatter(B1[8], A1[8],  facecolors='none', edgecolors='green', alpha=0.8, marker='^', s=17)
ax6.scatter(B1[9], A1[9],  facecolors='none', edgecolors='green', alpha=0.8, marker='*', s=17)
ax6.scatter(B1[10], A1[10],  facecolors='none', edgecolors='brown', alpha=0.8, marker='s', s=7) # c= "brown", alpha=0.8, marker='s', s=7
ax6.scatter(B1[11], A1[11],  facecolors='none', edgecolors='brown',  alpha=0.8, marker='D', s=7)
ax6.scatter(B1[12], A1[12],  facecolors='none', edgecolors='brown',  alpha=0.8, marker='^', s=17)
ax6.scatter(B1[13], A1[13],  facecolors='none', edgecolors='brown',  alpha=0.8, marker='*', s=17)
ax6.scatter(B1[14], A1[14],  facecolors='none', edgecolors='cyan',  alpha=0.8, marker='s', s=7)   #c= "cyan",  alpha=0.8, marker='s', s=7
ax6.scatter(B1[15], A1[15],  facecolors='none', edgecolors='cyan',  alpha=0.8, marker='D', s=7)
ax6.scatter(B1[16], A1[16],  facecolors='none', edgecolors='cyan', alpha=0.8, marker='^', s=17)
ax6.scatter(B1[17], A1[17],  facecolors='none', edgecolors='cyan',  alpha=0.8, marker='*', s=17)
ax6.scatter(B1[18], A1[18],  facecolors='none', edgecolors='magenta',   alpha=0.8, marker='s', s=7)#c= "magenta",alpha=0.8, marker='s', s=7)
ax6.scatter(B1[19], A1[19],  facecolors='none', edgecolors='magenta',  alpha=0.8, marker='D', s=7)
ax6.scatter(B1[20], A1[20],  facecolors='none', edgecolors='magenta',   alpha=0.8, marker='^', s=17)
ax6.scatter(B1[21], A1[21],  facecolors='none', edgecolors='magenta',  alpha=0.8, marker='*', s=17)
ax6.scatter(B1[22], A1[22],  facecolors='none', edgecolors='orange',   alpha=0.8, s=13,  marker='s')#c= "orange",alpha=0.8, s=13, marker='s')
ax6.scatter(B1[23], A1[23],  facecolors='none', edgecolors='orange',   alpha=0.8, s=13,  marker='D')
ax6.scatter(B1[24], A1[24],  facecolors='none', edgecolors='orange',   alpha=0.8, s=23,  marker='^')
ax6.scatter(B1[25], A1[25],  facecolors='none', edgecolors='orange',   alpha=0.8, s=23,  marker='*')
ax6.scatter(B1[26], A1[26],  facecolors='none', edgecolors='green',  alpha=0.8, s=13,  marker='s') # c= "green",alpha=0.8, s=13,  marker='s'
ax6.scatter(B1[27], A1[27],  facecolors='none', edgecolors='green', alpha=0.8, s=13,  marker='D')
ax6.scatter(B1[28], A1[28],  facecolors='none', edgecolors='green', alpha=0.8, s=23,  marker='^')
ax6.scatter(B1[29], A1[29],  facecolors='none', edgecolors='green', alpha=0.8, s=23,  marker='*')
ax6.scatter(B1[30], A1[30],  facecolors='none', edgecolors='brown', alpha=0.8, s=13,  marker='s')  #c= "brown", alpha=0.8, s=13,  marker='s')
ax6.scatter(B1[31], A1[31],  facecolors='none', edgecolors='brown', alpha=0.8, s=13,  marker='D')
ax6.scatter(B1[32], A1[32],  facecolors='none', edgecolors='brown', alpha=0.8, s=23,  marker='^')
ax6.scatter(B1[33], A1[33],  facecolors='none', edgecolors='brown', alpha=0.8, s=23,  marker='*')
ax6.scatter(B1[34], A1[34],  facecolors='none', edgecolors='cyan', alpha=0.8, s=13,  marker='s')  #c= "cyan", alpha=0.8, s=13,  marker='s')
ax6.scatter(B1[35], A1[35],  facecolors='none', edgecolors='cyan', alpha=0.8, s=13,  marker='D')
ax6.scatter(B1[36], A1[36],  facecolors='none', edgecolors='cyan', alpha=0.8, s=23,  marker='^')
ax6.scatter(B1[37], A1[37],  facecolors='none', edgecolors='cyan', alpha=0.8, s=23,  marker='*')
ax6.scatter(B1[38], A1[38],  facecolors='none', edgecolors='magenta', alpha=0.8, s=13,  marker='s') #c= "magenta",alpha=0.8, s=13,marker='s')
ax6.scatter(B1[39], A1[39],  facecolors='none', edgecolors='magenta', alpha=0.8, s=13,  marker='D')
ax6.scatter(B1[40], A1[40],  facecolors='none', edgecolors='magenta', alpha=0.8, s=23,  marker='^')
ax6.scatter(B1[41], A1[41],  facecolors='none', edgecolors='magenta', alpha=0.8, s=23,  marker='*')
ax6.scatter(B1[42], A1[42],  facecolors='none', edgecolors='orange', alpha=0.8, s=30,   marker='s') #c= "orange",alpha=0.8, s=30, marker='s', 
ax6.scatter(B1[43], A1[43],  facecolors='none', edgecolors='orange', alpha=0.8, s=30,  marker='D')
ax6.scatter(B1[44], A1[44],  facecolors='none', edgecolors='orange', alpha=0.8, s=40,  marker='^')
ax6.scatter(B1[45], A1[45],  facecolors='none', edgecolors='orange', alpha=0.8, s=40,  marker='*')
ax6.scatter(B1[46], A1[46],  facecolors='none', edgecolors='green', alpha=0.8, s=30,  marker='s') #c= "green", alpha=0.8, s=30,  marker='s',
ax6.scatter(B1[47], A1[47],  facecolors='none', edgecolors='green', alpha=0.8, s=30,  marker='D')
ax6.scatter(B1[48], A1[48],  facecolors='none', edgecolors='green', alpha=0.8, s=40,  marker='^')
ax6.scatter(B1[49], A1[49],  facecolors='none', edgecolors='green', alpha=0.8, s=40,  marker='*')
ax6.scatter(B1[50], A1[50],  facecolors='none', edgecolors='brown', alpha=0.8, s=30,  marker='s') #c= "brown", alpha=0.8, s=30,  marker='s',
ax6.scatter(B1[51], A1[51],  facecolors='none', edgecolors='brown', alpha=0.8, s=30,  marker='D')
ax6.scatter(B1[52], A1[52],  facecolors='none', edgecolors='brown', alpha=0.8, s=40,  marker='^')
ax6.scatter(B1[53], A1[53],  facecolors='none', edgecolors='brown', alpha=0.8, s=40,  marker='*')
ax6.scatter(B1[54], A1[54],  facecolors='none', edgecolors='cyan', alpha=0.8, s=30,  marker='s') #c= "cyan", alpha=0.8, s=30,  marker='s',
ax6.scatter(B1[55], A1[55],  facecolors='none', edgecolors='cyan', alpha=0.8, s=30,  marker='D')
ax6.scatter(B1[56], A1[56],  facecolors='none', edgecolors='cyan', alpha=0.8, s=40,  marker='^')
ax6.scatter(B1[57], A1[57],  facecolors='none', edgecolors='cyan', alpha=0.8, s=40,  marker='*')
ax6.scatter(B1[58], A1[58],  facecolors='none', edgecolors='magenta', alpha=0.8, s=30,  marker='s') #c= "magenta", alpha=0.8, s=30,  marker='s'
ax6.scatter(B1[59], A1[59],  facecolors='none', edgecolors='magenta', alpha=0.8, s=30,  marker='D')
ax6.scatter(B1[60], A1[60],  facecolors='none', edgecolors='magenta', alpha=0.8, s=40,  marker='^')
ax6.scatter(B1[61], A1[61],  facecolors='none', edgecolors='magenta', alpha=0.8, s=40,  marker='*')

ax6.scatter(B1[0], A1[0], c='black', alpha=0.8, s=40, label='Obs. halo PNe')
#ax6.scatter(B1[62],A1[62],  c= "yellow", alpha=0.8, marker='o', label='Obs. disk PN')
ax6.scatter(B1[1], A1[1], c='purple', alpha=0.8, label='SDSS CVs')
ax6.scatter(B1[127], A1[127],  c= "mediumaquamarine" , alpha=0.8, marker='s',  label='SDSS QSOs (4.01<z<5.0)')
ax6.scatter(B1[123], A1[123],  c= "royalblue", alpha=0.8, marker='D',  label='SDSS QSOs (3.01<z<4.0)')
ax6.scatter(B1[126], A1[126],  c= "goldenrod", alpha=0.8, s=38, marker='^',  label='SDSS QSOs (2.01<z<3.0)')
ax6.scatter(B1[125], A1[125],  c= "salmon", alpha=0.8, s=38, marker='*',  label='SDSS QSOs (1.01<z<2.0)')
ax6.scatter(B1[124], A1[124],  c= "sage", alpha=0.8, marker='o',  label='SDSS QSOs (0.01<z<1.0)')
ax6.scatter(B1[128], A1[128],  c= "white", alpha=0.3, s=38, marker='^', label='SDSS SFGs ')
ax6.scatter(B1[129], A1[129],  facecolors='none', edgecolors='red', alpha=0.8, s=38, marker='s')#, label='Obs. SySts ')
ax6.scatter(B1[137], A1[137],  c= "red", alpha=0.8, s=38, marker='s', label='Obs. SySts ')
#ax6.scatter(B1[72], A1[72],  c= "red", alpha=0.8, marker='D', label='Symbiotics in NGC 55')
ax6.scatter(B1[135], A1[135],  c= "red", alpha=0.8, s=38, marker='D', label=' Obs. SySts in NGC 205')
ax6.scatter(B1[136], A1[136],  facecolors='none', edgecolors='red', alpha=0.8, s=38, marker='D')  #label=' SySts in NGC 205')
ax6.scatter(B1[130], A1[130],  facecolors='none', edgecolors='red', alpha=0.8, s=38, marker='^')#,  label='IPHAS SySts')
ax6.scatter(B1[138], A1[138],  c= "red", alpha=0.8, s=38, marker='^', label='IPHAS SySts')
ax6.scatter(B1[140], A1[140],  facecolors='none', edgecolors='red', alpha=0.8, s=38, marker='o',  label='Obs. SySts in IC10 ')
ax6.scatter(B1[139], A1[139],  c= "red", alpha=0.8, s=38, marker='v', label=' Obs. SySts in NGC 185')
#ax6.scatter(B1[73], A1[73],  c= "red", alpha=0.8, marker='o', label='C. Buil Symbiotics')
ax6.scatter(B1[131], A1[131],  c= "gray", alpha=0.8, marker='D', label='Obs. HII region in NGC 55')
...
#ax6.legend(scatterpoints=1, ncol=1, fontsize=8.0, loc='upper left', **lgd_kws)
ax6.grid()
#lgd = ax6.legend(loc='center right', bbox_to_anchor=(1.27, 0.5), fontsize=7.5, **lgd_kws)
#ax.grid(which='minor', lw=0.5)
#sns.despine(bottom=True)
plt.tight_layout()
plt.savefig('luis-SPLUS-PNe-syst.pdf')#,  bbox_extra_artists=(lgd,), bbox_inches='tight')
plt.clf()
