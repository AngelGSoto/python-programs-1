...
q7 = (tab['Z_aper'] - tab['G_aper']) <= 4.0

mask1 = q  & q2 & q3 & q4 & q5 & q6 & q7
#Mask
Y = 2.7*(tab['F0515_aper'] - tab['F0861_aper']) + 2.15
Y1 = 0.2319*(tab['Z_aper'] - tab['G_aper']) + 0.85
Y2 = -1.3*(tab['Z_aper'] - tab['G_aper']) + 1.7
Y3 = 1.559*(tab['F0660_aper'] - tab['R_aper']) + 0.58
Y4 = 0.12*(tab['F0660_aper'] - tab['R_aper']) - 0.01
Y44 = -1.1*(tab['F0660_aper'] - tab['R_aper']) - 1.07
Y5 = 8.0*(tab['G_aper'] - tab['I_aper']) + 4.5
Y6 = 0.8*(tab['G_aper'] - tab['I_aper']) + 0.55
Y7 = 0.43*(tab['R_aper'] - tab['I_aper']) + 0.65
Y8 = -6.8*(tab['R_aper'] - tab['I_aper']) - 1.3

m = tab['Class star'] > 0.0 
m1 = tab['F0660_aper'] - tab['R_aper']<=-1.0 
m2 = tab['F0515_aper'] - tab['F0660_aper']>=0.3
m3 = tab['Z_aper'] - tab['F0660_aper']>=Y1
m4 = tab['Z_aper'] - tab['F0660_aper']>=Y2
m5 = tab['F0515_aper'] - tab['F0660_aper']>=Y
m6 = tab['F0660_aper'] - tab['G_aper']>=Y3
m7 = tab['G_aper'] - tab['F0515_aper']<=Y4
m8 = tab['G_aper'] - tab['F0515_aper']<=Y44
m9 = tab['F0410_aper'] - tab['F0660_aper']>=Y5
m10 = tab['F0410_aper'] - tab['F0660_aper']>=Y6
m11 = (tab['R_aper'] - tab['F0660_aper']) >= Y7
m12 = (tab['R_aper'] - tab['F0660_aper']) <= Y8
...
asciifile = "PN-SPLUS_STRIPE82_DataRelease-Junio18_aper.tab"
try:
