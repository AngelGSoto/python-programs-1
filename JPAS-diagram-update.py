...
def plot_mag(f1, f2, f3):
    ...
    x142, y142 = filter_mag("QSOs-30", "", f1, f2, f3)
...
ax1.set_xlim(xmin=-1.0,xmax=4.5)
ax1.set_ylim(ymin=-1.0,ymax=4.6)
#ax1.set_xlim(xmin=-2.5,xmax=2.0)
plt.tick_params(axis='x', labelsize=18) 
plt.tick_params(axis='y', labelsize=18)
plt.xlabel(r'$J5799 - J8300$', fontsize= 18)
plt.ylabel(r'$J5799 - J6600$', fontsize= 18)
...
plt.savefig('Fig1-JPAS-J6600-v0.pdf')
plt.clf()
...
ax2.set_ylim(ymin=-1.6,ymax=5.5)
#ax2.set_xlim(xmin=-2.5,xmax=2.0)
plt.tick_params(axis='x', labelsize=18) 
plt.tick_params(axis='y', labelsize=18)
plt.xlabel(r'$J4200 - J8400$', fontsize= 18)
plt.ylabel(r'$J4200 - J5001$', fontsize= 18)
...
ax2.annotate("H4-1", (np.array(B1[139]), np.array(A1[139])), alpha=10, size=8,
                   xytext=(-5, -12), textcoords='offset points', ha='right', va='bottom',)
...
ax2.legend(scatterpoints=1, ncol=1, fontsize=7.0, loc='upper right', **lgd_kws)
ax2.grid()
...
plt.tight_layout()
#plt.savefig('luis-JPLUS-Viironen.pdf')#,  bbox_extra_artists=(lgd,), bbox_inches='tight')
plt.savefig('Fig2-JPAS-J5001-v0.pdf')
plt.clf()
...
plt.tick_params(axis='x', labelsize=18) 
plt.tick_params(axis='y', labelsize=18)
plt.xlabel(r'$J4600 - J8100$', fontsize= 18)
plt.ylabel(r'$J4600 - J4701$', fontsize= 18)
...
(_, caps, _) = ax3.errorbar(B1[139], A1[139], xerr=0.0, yerr=0.0, marker='.', fmt='k.', elinewidth=0.8, markeredgewidth=0.8, markersize=8,)
for cap in caps:
    cap.set_markeredgewidth(1)
# ax3.errorbar(B1[139], A1[139], yerr=0.0,  uplims= True,  marker='.', fmt='k.', elinewidth=.8, markeredgewidth=.8, markersize=8,)
...
ax3.annotate("DdDm-1", (np.array(B1[141]), np.array(A1[141])), alpha=10, size=8,
                   xytext=(-15, -12), textcoords='offset points', ha='right', va='bottom',)
...
ax3.legend(scatterpoints=1, ncol=1, fontsize=7.0, loc='upper right', **lgd_kws)
ax3.grid()
...
plt.tight_layout()
#plt.savefig('luis-JPLUS-Viironen.pdf')#,  bbox_extra_artists=(lgd,), bbox_inches='tight')
plt.savefig('Fig3-JPAS-J4701-v1.pdf')
plt.clf()
