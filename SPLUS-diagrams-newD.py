...
def plot_mag(f1, f2, f3):
    ...
    x142, y142 = filter_mag("E00_300", "", f1, f2, f3)
    x143, y143 = filter_mag("E00_600", "", f1, f2, f3)
...
ax1.scatter(B1[142], A1[142], c="green", alpha=0.8, s=40,  marker='^',  label='Model PNe (3000cm^-3)')
ax1.scatter(B1[143], A1[143], c="red" , alpha=0.8, s=40,  marker='*', label='Model PNe (6000cm^-3)')
...
plt.savefig('Fig1-SPLUS-Viironen-newDv1.pdf')
plt.clf()
...
ax2.set_xlim(xmin=-2.0,xmax=5.2)
ax2.set_ylim(ymin=-1.0,ymax=5.2)
#ax2.set_xlim(xmin=-2.5,xmax=2.0)
plt.tick_params(axis='x', labelsize=18) 
plt.tick_params(axis='y', labelsize=18)
plt.xlabel(r'$J0515 - J0861$', fontsize= 18)
plt.ylabel(r'$J0515 - J0660$', fontsize= 18)
...
ax2.scatter(B1[142], A1[142], c="green", alpha=0.8, s=40,  marker='^',  label='Model PNe (3000cm^-3)')
ax2.scatter(B1[143], A1[143], c="red" , alpha=0.8, s=40,  marker='*', label='Model PNe (6000cm^-3)')
...
plt.tight_layout()
#plt.savefig('luis-JPLUS-Viironen.pdf')#,  bbox_extra_artists=(lgd,), bbox_inches='tight')
plt.savefig('Fig2-SPLUS-j0515-halpha-newDv1.pdf')
plt.clf()
...
plt.tick_params(axis='x', labelsize=18) 
plt.tick_params(axis='y', labelsize=18)
plt.xlabel(r'$J0660 - rSDSS$', fontsize= 18)
plt.ylabel(r'$J0660 - gSDSS$', fontsize= 18)
...
ax3.scatter(B1[142], A1[142], c="green", alpha=0.8, s=40,  marker='^',  label='Model PNe (3000cm^-3)')
ax3.scatter(B1[143], A1[143], c="red" , alpha=0.8, s=40,  marker='*', label='Model PNe (6000cm^-3)')
...
ax3.legend(scatterpoints=1, ncol=1, fontsize=7.0, loc='lower right', **lgd_kws)
ax3.grid()
...
plt.tight_layout()
#plt.savefig('luis-JPLUS-Viironen.pdf')#,  bbox_extra_artists=(lgd,), bbox_inches='tight')
plt.savefig('Fig3-SPLUS-halpha-r-newDv1.pdf')
plt.clf()
