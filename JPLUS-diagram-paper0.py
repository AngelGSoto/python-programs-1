...
def plot_mag(f1, f2, f3):
    ...
    x144, y144 = filter_mag("E00", "", f1, f2, f3)
    x145, y145 = filter_mag("E01", "", f1, f2, f3)
    x146, y146 = filter_mag("E02", "", f1, f2, f3)
    x147, y147 = filter_mag("E00_900", "", f1, f2, f3)
    x148, y148 = filter_mag("E01_900", "", f1, f2, f3)
    x149, y149 = filter_mag("E02_900", "", f1, f2, f3)
    for a, b in zip(x, y):
        A1[0].append(a)
        B1[0].append(b)
...
ax1.scatter(B1[140], A1[140],  c= "red", alpha=0.8, s=40, marker='o',  label='Obs. SySts in IC10 ')
...
for cap in caps:
    cap.set_markeredgewidth(1)
ax1.scatter(d_768_jplus[1], d_644_jplus[1],  c= "g", alpha=0.8, marker='o', s=70, label='J-PLUS PNG 135.9+55.9')
...
plt.savefig('Fig1-JPLUS-Viironen-v6.pdf')
plt.clf()
