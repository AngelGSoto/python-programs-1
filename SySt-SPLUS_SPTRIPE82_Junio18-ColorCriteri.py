'''
Getting SySt candidates in S-PLUS catalog (DR1-Juny)
'''
...
def select(magg, mag):
    ...
    q1 = (data['F0515_'+magg] - data['F0861_'+magg]) >= -3.0
    ...
    #Mask
    Y = 5.5*(data['F0515_'+magg] - data['F0861_'+magg]) - 6.45
    Y1 = 0.98*(data['F0515_'+magg] - data['F0861_'+magg]) - 0.16
    Y2 = -1.96*(data['Z_'+magg] - data['G_'+magg]) - 3.15
    Y3 = 0.2*(data['Z_'+magg] - data['G_'+magg]) + 0.44 
    Y4 = -220*(data['R_'+magg] - data['I_'+magg]) + 40.4
    Y44 = 0.39*(data['R_'+magg] - data['I_'+magg]) + 0.73
    Y5 = -4.7*(data['G_'+magg] - data['I_'+magg]) + 10.60
    Y6 = 2.13*(data['G_'+magg] - data['I_'+magg]) - 1.43
    Y7 = -0.19*(data['F0660_'+magg] - data['R_'+magg]) - 0.05
    Y8 = -2.66*(data['F0660_'+magg] - data['R_'+magg]) - 2.2

    #m = data['PROB_STAR'] >= 0.0
    m = data['PhotoFlag'] == 0.0
    m1 = data['F0515_'+magg] - data['F0660_'+magg]<= Y
    m2 = data['F0515_'+magg] - data['F0660_'+magg]>= Y1
    m3 = data['Z_'+magg] - data['F0660_'+magg]<= Y2
    m4 = data['Z_'+magg] - data['F0660_'+magg]>= Y3
    m5 = data['R_'+magg] - data['F0660_'+magg]>= Y4
    m6 = data['R_'+magg] - data['F0660_'+magg]>= Y44
    m7 = data['F0410_'+magg] - data['F0660_'+magg]>= Y5
    m8 = data['F0410_'+magg] - data['F0660_'+magg]>= Y6
    m9 = data['G_'+magg] - data['F0515_'+magg]>= Y7
    m10 = data['G_'+magg] - data['F0515_'+magg]<= Y8
