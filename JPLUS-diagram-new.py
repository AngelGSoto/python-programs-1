...
ax1.set_xlim(xmin=-3.0,xmax=0.9)
ax1.set_ylim(ymin=-3.0,ymax=1.5)
#ax1.set_xlim(xmin=-2.5,xmax=2.0)
plt.tick_params(axis='x', labelsize=18) 
plt.tick_params(axis='y', labelsize=18)
plt.xlabel(r'$J0660 - r$', fontsize= 18)
plt.ylabel(r'$g - J0515$', fontsize= 18)
...
ax1.annotate("DdDm-1", (np.array(B1[141]), np.array(A1[141])), alpha=10, size=8,
                   xytext=(-1, -10), textcoords='offset points', ha='right', va='bottom',)
#Obersevado porJPLUS
#for label_, x, y in zip(label1, d_768_jplus[0], d_644_jplus[0]):
# ax1.annotate("H4-1", (d_768_jplus[0], d_644_jplus[0]), alpha=8, size=8,
#                    xytext=(20, 3), textcoords='offset points', ha='right', va='bottom', color='blue',)

# ax1.annotate("PNG 135.9+55.9", (d_768_jplus[1], d_644_jplus[1]), alpha=8, size=8,
#                    xytext=(-3, -10), textcoords='offset points', ha='right', va='bottom', color='green',)
...
ax1.legend(scatterpoints=1, ncol=1, fontsize=7.0, loc='lower right', **lgd_kws)
ax1.grid()
...
plt.savefig('Fig2-JPLUS-g-r-J660-v0.pdf')
plt.clf()

###################################################################
#  g - 0430 vs j0410 - j0660   ####################################
####################################################################
label = []
label1 = ["H4-1", "PNG 135.9+55.9"]
n = 143
...
for file_name in file_list:
    with open(file_name) as f:
        ...
        if data['id'].startswith("ngc"):
            ...
            label.append("MWC 574")
        plot_mag("F410", "F660", "F480_g_sdss", "F861")
...
# ax2.set_xlim(xmin=-3.0,xmax=0.9)
# ax2.set_ylim(ymin=-3.0,ymax=1.5)
#ax2.set_xlim(xmin=-2.5,xmax=2.0)
plt.tick_params(axis='x', labelsize=18) 
plt.tick_params(axis='y', labelsize=18)
plt.xlabel(r'$gSSDS - J0861$', fontsize= 18)
plt.ylabel(r'$J0410 - J0660$', fontsize= 18)
...
ax2.legend(scatterpoints=1, ncol=1, fontsize=7.0, loc='lower right', **lgd_kws)
ax2.grid()
...
plt.tight_layout()
#plt.savefig('luis-JPLUS-Viironen.pdf')#,  bbox_extra_artists=(lgd,), bbox_inches='tight')
plt.savefig('Fig6-JPLUS-g-J0061-g-J660-v0.pdf')
plt.clf()
