...
if args.savefig:
    plotfile = file_.replace(".json", 
                    "-paper.pdf")
    fig = plt.figure(figsize=(15.8, 9.8)) #figsize=(14, 9)
    ...
    plt.text(0.68, 0.86, 'S-PLUS',
             transform=ax.transAxes, fontsize=60,  fontdict=font)
    # plt.text(0.80, 0.1, 'SySt',
    #          transform=ax.transAxes, fontsize=41,  fontdict=font)
    # plt.text(0.73, 0.86, 'HII region',
    #         transform=ax.transAxes, fontsize=41,  fontdict=font)
    # plt.text(0.75, 0.86, 'QSO',                                   #
    #         transform=ax.transAxes, fontsize=41,  fontdict=font)  #
    # plt.text(0.75, 0.78, 'z = 1.4',                               #QSO
    #         transform=ax.transAxes, fontsize=41,  fontdict=font)  #
    ...
    #          transform=ax.transAxes, fontsize=31,  fontdict=font)
    ...
    #         transform=ax.transAxes, fontsize=41,  fontdict=font)  #
    # plt.text(0.05, 0.86, 'PN of NGC 205 ',
    #          transform=ax.transAxes, fontsize=41,  fontdict=font)
