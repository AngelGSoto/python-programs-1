...
Y_vir0 = 0.43*(hdu_dt0["rSDSS"] - hdu_dt0["iSDSS"]) + 0.65
Y_vir10 = -6.8*(hdu_dt0["rSDSS"] - hdu_dt0["iSDSS"]) - 1.3

Y_vir1 = 0.43*(hdu_dt1["rSDSS"] - hdu_dt1["iSDSS"]) + 0.65
Y_vir11 = -6.8*(hdu_dt1["rSDSS"] - hdu_dt1["iSDSS"]) - 1.3

Y_vir2 = 0.43*(hdu_dt2["rSDSS"] - hdu_dt2["iSDSS"]) + 0.65
Y_vir12 = -6.8*(hdu_dt2["rSDSS"] - hdu_dt2["iSDSS"]) - 1.3

Y_vir3 = 0.43*(hdu_dt3["rSDSS"] - hdu_dt3["iSDSS"]) + 0.65
Y_vir13 = -6.8*(hdu_dt3["rSDSS"] - hdu_dt3["iSDSS"]) - 1.3
...
plt.tight_layout()
plt.savefig('Fig1-aegi-viironen.pdf')
plt.clf()
